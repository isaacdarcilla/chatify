  ...
  return (
    <>
      ...
      <section class="sectionSize items-start pt-8 md:pt-36 bg-black text-white">
        ...
        <div toggleElement class="w-full py-4">
          <div class="flex justify-between items-center">
            ...
            <img
              src="public/assets/logos/CaretRight.svg"
              alt=""
          ...
          <div
            answer
            class="font-montserrat text-sm font-extralight pb-8 hidden"
          >
      ...
      <section class="bg-black sectionSize">
        <div class="mb-4">
          <img src="public/assets/Logo_white.svg" alt="Logo" class="h-4" />
        </div>
        <div class="flex mb-8">
          <a href="#">
            <img
              src="public/assets/logos/Facebook.svg"
              alt="Facebook logo"
              class="mx-4"
            />
          </a>
          <a href="#">
            <img
              src="public/assets/logos/Youtube.svg"
              alt="Youtube logo"
              class="mx-4"
            />
          </a>
          <a href="#">
            <img
              src="public/assets/logos/Instagram.svg"
              alt="Instagram logo"
              class="mx-4"
            />
          </a>
          <a href="#">
            <img
              src="public/assets/logos/Twitter.svg"
              alt="Twitter logo"
              class="mx-4"
            />
          </a>
